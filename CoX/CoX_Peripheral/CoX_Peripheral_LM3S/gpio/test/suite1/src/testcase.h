...
//
#define TEST_COMPONENTS_NAME    "Stellaris LM3Sxxxx COX Packet"
...
//! \brief Evkit name
//
#define TEST_BOARD_NAME         "LM3S9B96 board"
...
//
//*****************************************************************************
//extern const tTestCase * const psPatternxgpio001[];
extern const tTestCase * const psPatternxgpio002[];
