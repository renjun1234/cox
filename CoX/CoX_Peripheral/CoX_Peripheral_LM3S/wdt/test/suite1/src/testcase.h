...
//
#define TEST_COMPONENTS_NAME    "Texas instruments Stellaris PWM COX Packet"
...
//
//*****************************************************************************
extern const tTestCase * const psPatternXwdt001[];
extern const tTestCase * const psPatternXwdt002[];
//extern const tTestCase * const psPatternXwdt02[];
